...
procedure CreateCompletedTaskCard(ParentLayout: TLayout;
  CardTitle, CardDescription, Priority, CreatedOn: string);
...
begin
  ...
  begin
    ...
    Size.Width := 120;
    Size.Height := 120;
    LoadImageFromResource('bg2', Bitmap)
  end;
...
begin
  ...
  begin
    ...
    TextSettings.Font.Family := 'Inter';
    TextSettings.Font.Size := 11;
    TextSettings.FontColor := $FF05A301;
    Text := 'Completed';
  end;
